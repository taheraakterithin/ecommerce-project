...
<nav class="navbar navbar-inverse navbar-fixed-top" >
    ...
    <button onclick="myFunction()" class="dropbtn">
      <img src="girl.jpg" alt="Profile Picture" class="profile-pic"> 
      <?php echo $admin_name; ?>
    </button>
...
<li class="button-dropdown" >
  ...
  <li>
  	<a href="index.php?chat">
  		<i class="fa fa-fw fa-list"></i> Chat
  	</a>
  </li>
  <li>
  ...
  <li class="button-dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#users"><i class="fa fa-fw fa-table"></i>  Offline payment <i class="fa fa-fw fa-caret-down"></i></a>

    <ul id="#users" class="dropdown-menu">
      <li>
        <a href="index.php?offline_payment_approve">Offline payment approve</a>
      </li>
     </ul>
  </li>
...
.profile-pic {
    ...
    max-height: 40px; /* Constrain height to the same as width */
